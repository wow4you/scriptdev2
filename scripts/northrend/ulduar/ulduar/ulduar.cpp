...
SDName: ulduar
SD%Complete: 10%
SDComment: Teleporters are hacked until solved in MaNGOS
SDCategory: Ulduar
EndScriptData */
...
/* ****
* The teleporter spells cannot be used atm, because target-type TARGET_SCRIPT_COORDINATES, NO_TARGET is not yet suitable for needed targeting. (Current MaNGOS-Design)
